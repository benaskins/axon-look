...
func (s *Server) Handler() http.Handler {
	...
	if s.ch != nil {
		...
		mux.Handle("GET /api/evals/bfcl", &bfclRunsHandler{db: s.ch})
		mux.Handle("GET /api/evals/bfcl/compare", &bfclCompareHandler{db: s.ch})
		mux.Handle("GET /api/evals/bfcl/{run_id}", &bfclDetailHandler{db: s.ch})
